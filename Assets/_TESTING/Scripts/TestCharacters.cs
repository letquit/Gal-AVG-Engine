...
namespace TESTING
{
    public class TestCharacters : MonoBehaviour
    {
        ...
        private IEnumerator Test1()
        {
            ...
            yield return PunChan.MoveToPosition(new Vector2(0.5f, 0));
            
            PunChan.SetExpression("A", 100);
            PunChan.SetExpression("Close Eye L", 100);
            PunChan.SetExpression("Close Eye R", 100);
            PunChan.SetMotion("Wave");
            
            yield return new WaitForSeconds(3f);
            
            PunChan.SetExpression("A", 0, immediate: true);
        }
    }
}